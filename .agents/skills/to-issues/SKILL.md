---
name: to-issues
source: https://skills.sh/mattpocock/skills/to-issues
installs: 41800
description: "Descompone un plan en issues independientes usando vertical slices (tracer bullets). Cada issue es un slice vertical que corta a través de TODAS las capas de integración de punta a punta."
argument-hint: "Plan, PRD o feature a descomponer en issues"
---
...
body template below. Apply the `needs-triage` triage label so each issue enters the normal triage flow.
