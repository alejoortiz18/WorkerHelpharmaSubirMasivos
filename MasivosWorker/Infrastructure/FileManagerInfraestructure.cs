...
namespace Infrastructure
{
    public class FileManagerInfraestructure
    {
            ...
            string etiqueta)
        {
            ...
            MoverArchivoConReintentos(rutaOrigen, destino);
        ...
        private static void MoverArchivoConReintentos(string rutaOrigen, string rutaDestino)
        {
