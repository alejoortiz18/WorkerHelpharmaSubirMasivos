...
installs: 60300
description: "Analiza la fricción arquitectónica del codebase y propone oportunidades de deepening — refactors que convierten módulos superficiales en módulos profundos. El objetivo es testeabilidad y navegabilidad."
argument-hint: "Área o módulo donde se siente fricción arquitectónica"
---
...
- **Module** — anything with an interface e implementación (function, class, package, slice).
...
- Naming a deepened module after a concept not in the domain glossary? Add the term.
- Sharpening a fuzzy term during the conversation? Update the glossary right there.
- User rejects the candidate with a load-bearing reason? Offer an ADR to record it for future reviews.
