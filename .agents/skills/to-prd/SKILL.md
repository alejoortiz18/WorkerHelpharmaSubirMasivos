---
name: to-prd
source: https://skills.sh/mattpocock/skills/to-prd
installs: 44400
description: "Toma el contexto de la conversación y el entendimiento del codebase para producir un PRD (Product Requirements Document). NO entrevista al usuario — sintetiza lo que ya se sabe."
argument-hint: "Feature o mejora a documentar como PRD"
---
...
already. Use the project's domain glossary vocabulary throughout the PRD, and
...
implementation. Actively look for opportunities to extract deep modules that can
...
tracker. Apply the `needs-triage` triage label so it enters the normal triage flow.
...
within the relevant decision and note briefly that it came from a prototype. Trim to
